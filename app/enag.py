...
-------------------------------------------
ENAG'ın herkese açık bir API'si YOKTUR ve resmi sitesi (enagrup.org) şu an
otomatik erişime kapalıdır (Cloudflare HTTP 525). Bu yüzden ENAG verisi EVDS gibi
canlı çekilemez; aşağıdaki aylık oranlar topluluk kaynaklı olarak derlenmiştir
(kaynak: github.com/muslumyalcin-git/enflasyon-matrix).
...
tutar. Yıllık çapası olmayan dönemler (2025–2026) ham haliyle kullanılır ve
"doğrulanmamış" olarak işaretlenir.

Veriyi güncellemek için: aşağıdaki ENAG_MONTHLY_RATES sözlüğüne yeni ayı ekleyin
(örn. "2026-04": 4.2) ve mümkünse yeni yıl kapanınca ENAG_ANNUAL_OFFICIAL çapasını girin.
"""
...
# Aylık ENAG enflasyon oranları (%) — topluluk kaynaklı, ham veri.
ENAG_MONTHLY_RATES: dict[str, float] = {
    # 2020: ENAG Eylül 2020'de kuruldu; gerçek zamanlı aylık veri o tarihte başlar.
    # Yıl sonu (2020) ENAG enflasyonu resmi olarak %36,72'dir (kaynak: Sözcü, Oca 2021)
    # ve Aralık 2020 aylık oranı %4,08'dir. Ocak–Kasım 2020, doğrulanmış yıllık orana
    # eşit dağıtılmış yaklaşık değerlerdir (yıl bazında normalizasyon ile tam %36,72 tutar).
    ...
    "2024-05": 3.37, "2024-06": 2.40, "2024-07": 4.75, "2024-08": 3.65,
    "2024-09": 4.40, "2024-10": 3.74, "2024-11": 2.13, "2024-12": 2.11,
    "2025-01": 8.22, "2025-02": 3.37, "2025-03": 3.50, "2025-04": 4.46,
    "2025-05": 2.50, "2025-06": 2.30, "2025-07": 2.80, "2025-08": 2.60,
    "2025-09": 3.79, "2025-10": 3.74, "2025-11": 2.13, "2025-12": 2.11,
    "2026-01": 5.20, "2026-02": 4.01, "2026-03": 4.10,
}
...
ENAG_ANNUAL_OFFICIAL: dict[int, float] = {
    2020: 36.72,   # ENAG'ın açıkladığı 2020 yıl sonu enflasyonu (Sözcü, Oca 2021)
    2021: 82.81,
    2022: 137.55,
    2023: 127.21,
    2024: 83.40,
...
def _build_index() -> tuple[dict[str, float], set[int]]:
    ...
    Yıllık resmi çapası olan yıllar (2021–2024) için o yılın aylık çarpanları,
    bileşikleri resmi yıllık orana eşit olacak şekilde log-uzayında ölçeklenir.
    İç temel: 2020-12 = 100 (kullanıcıya sunulan ilk ay 2021-01).
    """
    ...
    level = 100.0  # 2020-12 = 100 (iç temel)
    for m in months:
